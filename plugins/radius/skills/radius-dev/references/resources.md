...
- [EIP-7966](https://eips.ethereum.org/EIPS/eip-7966) — `eth_sendRawTransactionSync` (synchronous tx submission; a broadly-recognized standard method — the Radius edge is that the sync receipt is instant + final, no reorg)
